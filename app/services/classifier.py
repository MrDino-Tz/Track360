...
_RULES: list[tuple[str, re.Pattern[str]]] = [
    ...
    ("STOPPAGE", re.compile(r"\b(stop|stopped|stuck|jammed|down|halted|not working)\b", re.I)),
    ("ELECTRICAL", re.compile(r"\b(electric|electrical|power|trip|tripped|voltage)\b", re.I)),
    ("MECHANICAL", re.compile(r"\b(motor|belt|bearing|gear|shaft|conveyor)\b", re.I)),
]
